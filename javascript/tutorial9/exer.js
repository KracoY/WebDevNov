...
//     let pep = people
//     const obj = {id:pep.id, name:pep.name, user:pep.username, mail:pep.email, address: pep.address} 
//     console.log(pep.id);
// }
...
for (singleobj in people ) {
    ...
    //console.log(obj)
    const { id, name, username, email, address } = obj
    const { street } = address
    console.log(id, name, username, email, address, street);
