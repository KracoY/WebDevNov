...
//     console.log('mouse if away from html')
// })

// //
// document.addEventListener('DOMContentLoaded', ()=>{
//     console.log('hello page has been loaded!!!!!')
//     let db = JSON.parse(localStorage.geetItem('movies'))
//     db.forEach(movie=>{
//         console.log(movie)
//     })
// })
...
// console.log('hello page has been loaded !!!!')
// let db = JSON.parse(moacalStorage.getItem('movies'))
// db.forEach(movie=>{
//     console.log(movie);
// })
...
//     legend.innerText='DATA cut!'
// })

// //paste event
// book_name.addEventListener('paste' ,e=>{
//     legend.innerText='DATA PASTE!'
// })
